...
Sub CaptureDisplacementContours()
    ...
    For i = LBound(jobs) To UBound(jobs)
        ...
        ' ENV_EQ exists only when the culvert builder's seismic gate is on.
    ...
    report = "Culvert displacement contour capture  [" & SCRIPT_VERSION & "]" & vbCrLf & _
