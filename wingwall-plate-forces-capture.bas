...
Private Const SCRIPT_VERSION As String = "2026-09-23h"
...
'
' UCS_NAME accepts this real name, although the Plate Forces doc's enum
' lists only the literal "CurrentUCS". Confirmed live 2026-09-22 on a
' synthetic model and 2026-09-23 on the real wingwall: component values
' under "FOUND" differ from "CurrentUCS"/"Local". If foundation pictures
' ever come back blank rather than rotated, suspect the element
' orientation, not the name (see CLAUDE.md).
'
...
Sub CaptureWingwallPlateForces()
    ...
    report = "Wingwall plate forces capture  [" & SCRIPT_VERSION & "]" & vbCrLf & _
