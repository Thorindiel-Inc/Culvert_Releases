...
Private Const SCRIPT_CHANGELOG As String = "Adds DISPLAY.VIEW.UCS_AXIS to draw the UCS triad on foundation captures - confirmed a no-op in the API and in Civil NX's own GUI, kept harmlessly."
